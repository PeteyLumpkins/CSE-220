...
part_2_D:
	...
	andi $a0, $s0, 0xFFFF
	andi $t0, $a0, 0x7FFF	# we want to get the sign bit
	beqz $t0 print_integer	# if sign-bit == 0, then print out the integer
	
	xori $a0, $a0, 0xFFFF	# flip all of the bits
	addi $a0, $a0, 1	# add one 
	
	li $t0, -1	
	mul $a0, $a0, $t0	# multiply by -1
